...
# тяжек путь, для того, чтобы заиметь этот файл в селениуме есть функция, выполните ее, либo дождитесь, я позже сделаю автоматизацию, пока что groups есть в гите
